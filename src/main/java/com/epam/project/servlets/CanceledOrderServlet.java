...
public class CanceledOrderServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<Subscription> subscriptionList=  SubscriptionServiceImpl.getInstance().findSubscriptionsBy2BookStatusAndUser(Status.ORDERED_ROOM,Status.ORDERED_SUBSCRIPTION,(Long) session.getAttribute("user_id"));
