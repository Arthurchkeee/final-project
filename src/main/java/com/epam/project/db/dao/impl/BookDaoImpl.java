...
public class BookDaoImpl implements BookDao {
    ...
    public List<Book> selectBooksForPages(Integer booksAmount, Integer pageNumber) {
        List<Book> books = new ArrayList<>();
        try (Connection connection = ConnectionPool.getInstance().getConnection();
             PreparedStatement preparedStatement = connection.prepareStatement(SELECT_BOOKS_FOR_PAGE)) {
